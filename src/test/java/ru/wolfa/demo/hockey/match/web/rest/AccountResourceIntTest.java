...
import ru.wolfa.demo.hockey.match.domain.PersistentToken;
import ru.wolfa.demo.hockey.match.domain.User;
import ru.wolfa.demo.hockey.match.repository.AuthorityRepository;
import ru.wolfa.demo.hockey.match.repository.PersistentTokenRepository;
import ru.wolfa.demo.hockey.match.repository.UserRepository;
import ru.wolfa.demo.hockey.match.security.AuthoritiesConstants;
import ru.wolfa.demo.hockey.match.service.MailService;
import ru.wolfa.demo.hockey.match.service.dto.UserDTO;
import ru.wolfa.demo.hockey.match.service.dto.PasswordChangeDTO;
import ru.wolfa.demo.hockey.match.web.rest.errors.ExceptionTranslator;
import ru.wolfa.demo.hockey.match.web.rest.vm.KeyAndPasswordVM;
import ru.wolfa.demo.hockey.match.web.rest.vm.ManagedUserVM;
import ru.wolfa.demo.hockey.match.service.UserService;
