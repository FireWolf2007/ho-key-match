...
import { GameMySuffixComponent } from 'app/entities/game-my-suffix/game-my-suffix.component';
...
describe('Component Tests', () => {
    describe('GameMySuffix Management Component', () => {
        let comp: GameMySuffixComponent;
        let fixture: ComponentFixture<GameMySuffixComponent>;
        let service: GameMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HockeyMatchTestModule],
                declarations: [GameMySuffixComponent],
                providers: [
                    GameMySuffixService,
                    {
                ...
                .overrideTemplate(GameMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(GameMySuffixComponent);
