    ...
    describe('Tournament Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tournaments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Tournament', () => {
                service.create(new Tournament(null)).subscribe(received => {
            ...
            it('should update a Tournament', () => {
                service.update(new Tournament(123)).subscribe(received => {
