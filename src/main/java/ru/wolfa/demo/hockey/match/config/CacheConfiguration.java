package ru.wolfa.demo.hockey.match.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("HockeyMatch");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("HockeyMatch");
        ...
        config.getMapConfigs().put("ru.wolfa.demo.hockey.match.domain.*", initializeDomainMapConfig(jHipsterProperties));
