...
@Component({
    selector: 'jhi-game-my-suffix',
    templateUrl: './game-my-suffix.component.html'
})
export class GameMySuffixComponent implements OnInit, OnDestroy {
    games: IGameMySuffix[];
    currentAccount: any;
    ...
    loadAll() {
        this.gameService
            ...
            .subscribe(
                (res: HttpResponse<IGameMySuffix[]>) => this.paginateGames(res.body, res.headers),
    ...
    trackId(index: number, item: IGameMySuffix) {
        return item.id;
    }
    ...
    private paginateGames(data: IGameMySuffix[], headers: HttpHeaders) {
