...
type EntityResponseType = HttpResponse<ITeamMySuffix>;
type EntityArrayResponseType = HttpResponse<ITeamMySuffix[]>;
...
export class TeamMySuffixService {
    ...
    update(team: ITeamMySuffix): Observable<EntityResponseType> {
        return this.http.put<ITeamMySuffix>(this.resourceUrl, team, { observe: 'response' });
    }
