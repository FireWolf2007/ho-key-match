...
export class TeamMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.teamService
            ...
            .subscribe(
                (res: HttpResponse<ITeamMySuffix[]>) => this.paginateTeams(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/team-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ITeamMySuffix) {
        return item.id;
    }
    ...
    private paginateTeams(data: ITeamMySuffix[], headers: HttpHeaders) {
